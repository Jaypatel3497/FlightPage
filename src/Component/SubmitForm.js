...
class Submitform extends Component {
  ...
  render() {
    ...
    return (<div>{this.props.added?(
      ...
      <input type="hidden" id="_agile_confirmation_msg" name="_agile_confirmation_msg" value={"Ticket from " + this.props.params.origin + " to "+this.props.params.destination +" on "+this.props.params.departure_date + " at price " +this.props.params.price + " has successfully booked"}></input>
      ...
      <input id="agilefield-7" name="From" type="hidden" value={this.props.params.origin}></input>
      <input id="agilefield-10" name="Price" type="hidden" value={this.props.params.price}></input>
      <input id="agilefield-8" name="To" type="hidden" value={this.props.params.destination}></input>
      <input id="agilefield-9" name="Date" type="hidden" value={this.props.params.departure_date}></input>
